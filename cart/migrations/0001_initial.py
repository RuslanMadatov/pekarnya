    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_key', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sessions.session', verbose_name='Анонимный Пользователь')),
            ],
            options={
